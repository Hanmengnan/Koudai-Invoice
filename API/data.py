...
class Data():
    ...
    def __init__(self , html):
        ...
        info['gfNsrsbh'] = t.xpath(
            '//span[contains(@id,"gfsbh_dzfp")]/text()')[0]
        info['gfContact'] = t.xpath(
            '//span[contains(@id,"gfdzdh_dzfp")]/text()')[0]
        info['gfBank'] = t.xpath(
            '//span[contains(@id,"gfyhzh_dzfp")]/text()')[0]
        # 以下项目有多个匹配结果
        service_name = []
        model = []
        unit = []
        ...
        for i in range(2 , len(t.xpath('//*[@class="fppy_table_box"]/tbody/tr')) - 1):
            try:
                service_name.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[1]//text()')[0])
            except:
                service_name.append(' ')
            try:
                model.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[2]//text()')[0])
            except:
                model.append(' ')
            try:
                unit.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[3]//text()')[0])
            except:
                unit.append(' ')
            try:
                nums.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[4]//text()')[0])
            except:
                nums.append(' ')
            try:
                price.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[5]//text()')[0])
            except:
                price.append(' ')
            try:
                money.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[6]//text()')[0])
            except:
                money.append(' ')
            try:
                rate.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[7]//text()')[0])
            except:
                rate.append(' ')
            try:
                tax.append(
                    t.xpath('//*[@class="fppy_table_box"]/tbody/tr[' + str(i) + ']/td[8]//text()')[0])
            except:
                tax.append(' ')
        ...
        info['shuilv'] = rate
        info['shuie'] = tax
        info['goodsamount'] = t.xpath(
            '//span[contains(@id,"je_dzfp")]/text()')[0]
        info['taxamount'] = t.xpath(
            '//span[contains(@id,"se_dzfp")]/text()')[0]
        info['SUMAMOUNT'] = t.xpath(
            '//span[contains(@id,"jshjdx_dzfp")]/text()')[0]
        info['sumamount'] = t.xpath(
            '//span[contains(@id,"jshjxx_dzfp")]/text()')[0]
        ...
        try:
            ...
            info['remark'] = ' '
        info['xfNsrsbh'] = t.xpath(
            '//span[contains(@id,"xfsbh_dzfp")]/text()')[0]
        info['xfContact'] = t.xpath(
            '//span[contains(@id,"xfdzdh_dzfp")]/text()')[0]
        info['xfBank'] = t.xpath(
            '//span[contains(@id,"xfyhzh_dzfp")]/text()')[0]
        self.info = info

    # 将html文件写出
    def write(self):
        with open(r'C:\Users\Administrator\Desktop\invoice\API\Mould' + '\\' + self.info['fpdm'] + self.info[
            'fphm'] + '.html' , 'w' , encoding='utf-8') as f:
    ...
    def getpic(self):
        ...
        os.system('wkhtmltoimage.exe ' + r'C:\Users\Administrator\Desktop\invoice\API\Mould' + '\\' +
                  self.info['fpdm'] + self.info[
                      'fphm'] + '.html' + ' C:\\Users\\Administrator\\Desktop\\invoice\\spider\\images\\' + self.info[
                      'fpdm'] + self.info['fphm'] + '.png')
